...
## No, there are only 100 spring and 100 fall to begin with in 2023. Can't drop from 190!!
pepe23_26 %>%
...
## 95 of them (should be 100) and they are all duplicated. That comes to the 190 because spring measurement and fall. Did 5 die by the fall?
...
ggplot(Phi.table, aes(time, estimate, color = Transplant)) +
  ...
  ylab("Survival") +
  xlab("Year") +
  scale_color_discrete(labels = c("In-situ","Transplant"))+
  xlab("2023-2026")
