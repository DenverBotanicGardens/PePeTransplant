...
#   filter(date == "2024-06-24" & transplantSeason %in% c("Spring","Fall")) %>%
#   group_by(plantID, transectID, transplantSeason, transectPosition) %>%
#   summarise(n = n()) %>%
#   filter(n > 1) %>%
#   print(n = 48)
...
#   group_by(date, plantID) %>%
#   mutate(recordedBy = paste0("Obs", row_number())) %>%
#   filter(plantID %in% c(10:14,16:19,31:40,81:85,87:90,110:118,145,148:151,167:170,1752)) %>%
#   select(plantID, date, heightInCentimeters, recordedBy, transplantSeason, transectPosition, transectID) %>%
#   arrange(plantID, date, transectID, transectPosition) %>%
#   group_by(date, transectPosition, transectID) %>%
#   summarise(n = n()) %>%
#   filter(n > 1) %>%
#   print(n = 47)
...
surv2023_2024 <- surv2023_2024 %>%
  ...
  #                              v recordedBy == "Geena Poulter, Michelle DePrenger-Levin" ~ "GP_MEDL",
...
### need to treat may and october as Obs1 and Obs2 for 2023
### why aren't there 
```
