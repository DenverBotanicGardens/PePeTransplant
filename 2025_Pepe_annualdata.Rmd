...
MPM.pepe.control <- matrix( c(Phi.table.type$estimate[Phi.table.type$stratum == "V" & 
  ...
  Phi.table.type$estimate[Psi.table.type$stratum == "R" & Phi.table.type$Type == "CT"] + f.all$estimate,
...
MPM.pepe.transplant <- matrix( c(Phi.table.type$estimate[Phi.table.type$stratum == "V" & 
  ...
  Phi.table.type$estimate[Psi.table.type$stratum == "R" & Phi.table.type$Type == "TT"] + f.all$estimate,
